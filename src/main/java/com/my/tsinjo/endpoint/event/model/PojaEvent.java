package com.my.tsinjo.endpoint.event.model;

import static com.my.tsinjo.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.my.tsinjo.PojaGenerated;
import com.my.tsinjo.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.my.tsinjo.event1";
    return "com.my.tsinjo.event2";
  }
}
