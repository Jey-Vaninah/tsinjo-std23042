package com.my.tsinjo.endpoint.event.consumer;

import com.my.tsinjo.PojaGenerated;
import com.my.tsinjo.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.my.tsinjo.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.my.tsinjo.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
